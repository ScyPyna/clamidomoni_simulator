...
def train():
    # carica dataset
    data = np.load("dataset/dataset_all.npy", allow_pickle=True)
    n    = len(data)
    ...
    for epoch in range(300):
        ...
        if loss_val < best_val:
            best_val = loss_val
            torch.save(model.state_dict(), "dataset/best_model_all.pt")
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("dataset/training_history_all.png", dpi=120)
