...
intensity=180                                               #intensity from experimental data (ring)
newint=180                                                  #make simulation map with different intensity wrt experiments
...
large=False                                                  #intensity from experimental data (large ring)
